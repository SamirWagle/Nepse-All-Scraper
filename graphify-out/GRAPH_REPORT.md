# Graph Report - Nepse-CAGR  (2026-08-08)

## Corpus Check
- 54 files · ~373,458 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1779 nodes · 4447 edges · 92 communities (79 shown, 13 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 125 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `12857814`
...
Cohesion: 0.05
Nodes (34): a(), beforeLayout(), bo, buildLookupTable(), buildTicks(), determineDataLimits(), En, Fo() (+26 more)
...
Cohesion: 0.05
Nodes (45): ao(), be(), dataset(), e(), es(), et(), generateLabels(), getRange() (+37 more)
...
Cohesion: 0.1
Nodes (14): co(), Do(), eo(), getCenterPoint(), gn, Hs, ki(), lo() (+6 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (23): DailyScraperManager, Run the daily update:           - Refresh company ID mapping (catches new IPOs), Run the daily update:           - Refresh company ID mapping (catches new IPOs), Run the daily update:           - Refresh company ID mapping (catches new IPOs), Manages daily scraping tasks for priority companies (company_list.json):       -, Manages daily scraping tasks for priority companies (company_list.json):       -, Load the priority company list from company_list.json., Load the priority company list from company_list.json. (+15 more)

### Community 7 - "Community 7"
Cohesion: 0.14
Nodes (18): afterDraw(), ai(), ba(), draw(), ea(), ee, ft(), ie (+10 more)

### Community 8 - "Community 8"
Cohesion: 0.12
Nodes (9): Ae(), ci(), fi, getPixelForTick(), gs(), ks(), po(), Us() (+1 more)

### Community 9 - "Community 9"
Cohesion: 0.13
Nodes (5): an(), ke(), s(), u(), wn()

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (33): backDestination, bearBottoms, BTC_BOTTOMS, BTC_BULL_CYCLES, BTC_CYCLE_BOTTOMS, BTC_FORWARD_RETURNS, BTC_TOPS, btn (+25 more)

### Community 11 - "Community 11"
Cohesion: 0.09
Nodes (29): _extract_fy(), _fetch_chukul_paid_up_capital(), _fetch_nepsealpha_paid_up_capital(), _fetch_shareholding(), _fetch_sharesansar_shares(), _firecrawl_markdown(), _parse_nepali_fy(), _parse_number() (+21 more)

### Community 12 - "Community 12"
Cohesion: 0.1
Nodes (16): at(), Bi(), gt(), it(), jt(), kt(), mt(), pt() (+8 more)
...
Cohesion: 0.17
Nodes (8): afterEvent(), bs, f(), la(), oa(), ra(), update(), va
...
Cohesion: 0.08
Nodes (28): MerolaganiFundamentalsScraper, Scrape per-company fundamentals from merolagani.com., Scrape per-company fundamentals from merolagani.com., Scrape per-company fundamentals from merolagani.com., Scrape per-company fundamentals from merolagani.com., build_adjusted_series(), _build_events(), calculate_cagr() (+20 more)

### Community 18 - "Community 18"
Cohesion: 0.15
Nodes (13): ca(), _calculateBarIndexPixels(), _calculateBarValuePixels(), getBasePixel(), getLabelAndValue(), getPixelForValue(), _getRuler(), _getStackCount() (+5 more)
...
Cohesion: 0.1
Nodes (22): calculate_cagr(), get_cagr(), load_dividends(), load_prices(), load_right_shares(), main(), nearest_price(), NEPSE Stock CAGR Calculator ============================ Uses data from: https:/ (+14 more)
...
Cohesion: 0.15
Nodes (3): afterDatasetsUpdate(), jn, onClick()

### Community 24 - "Community 24"
Cohesion: 0.12
Nodes (9): bn, cn(), dn(), i, je(), on(), qe(), un() (+1 more)

### Community 25 - "Community 25"
Cohesion: 0.13
Nodes (6): afterUpdate(), c(), d(), di(), kn(), qn()
...
Cohesion: 0.21
Nodes (7): cs, fe(), nn(), pi(), removeBox(), sn, stop()
...
Cohesion: 0.19
Nodes (17): fetch_registry(), fetch_traded_symbols(), find_renames(), _load_json(), merge_registry(), parse_registry(), Return new (mapping, names) dicts with missing symbols added, renames applied., Every symbol on ShareSansar's latest Today's Share Price table. (+9 more)

### Community 39 - "Community 39"
Cohesion: 0.21
Nodes (17): collect(), _last_date_in_column(), _mtime_date(), _newest_floorsheet_date(), _newest_mtime(), _newest_price_date(), _oldest_index_date(), _parse() (+9 more)
...
Cohesion: 0.19
Nodes (14): _(), aa(), b(), ce(), g(), he(), m(), o() (+6 more)
...
Cohesion: 0.21
Nodes (5): constructor(), de, dt(), ia(), qs()

### Community 45 - "Community 45"
Cohesion: 0.17
Nodes (13): doBullSearch(), doLtpLookup(), getTradingRange(), renderBullBoxes(), resolveSymbolPage(), showVerdict(), toggleNepseComparison(), toggleTickerOverlay() (+5 more)

### Community 46 - "Community 46"
Cohesion: 0.2
Nodes (14): load_priority_companies(), main(), run_github_actions.py ===================== Daily scraper designed for GitHub Ac, Return a set of values from key_col in an existing CSV., Return a set of values from key_col in an existing CSV., Scrape dividends for every company-wise dir that has prices.csv but no dividend., Return list of symbols from company_list.json., Return list of symbols from company_list.json. (+6 more)

### Community 47 - "Community 47"
Cohesion: 0.21
Nodes (7): BaseHTTPRequestHandler, calculate_index_cagr(), Handler, Hide a digest item once read, or put it back.          Reversible by design, whi, Hide a digest item once read, or put it back.          Reversible by design, whi, Remove one archived digest and its snapshot row. Irreversible., Remove one archived digest and its snapshot row. Irreversible.

### Community 48 - "Community 48"
Cohesion: 0.27
Nodes (10): fn, go(), l(), parse(), parseArrayData(), parseObjectData(), parsePrimitiveData(), resolveDataElementOptions() (+2 more)

### Community 49 - "Community 49"
Cohesion: 0.25
Nodes (3): addBox(), bt, start()
...
Cohesion: 0.26
Nodes (12): _auto_detect_data_dir(), clean_dataframe(), get_latest_date_in_csv(), _print_row(), prompt_for_date(), query_index(), index_history.py ---------------- Scrapes historical NEPSE index / sub-index dat, Ask user for a date interactively. Returns date string or None. (+4 more)
...
Cohesion: 0.29
Nodes (12): doCagr(), doSearch(), localResolveCandidates(), openBullBearFromQuery(), resolveBullSymbol(), resolveSymbol(), runFundamentalsForSymbol(), runIndexBullBear() (+4 more)
...
Cohesion: 0.49
Nodes (9): findPort(), ensure_engine_running(), find_port(), main(), post_to_engine(), read_message(), send_message(), start_engine() (+1 more)

### Community 67 - "Community 67"
Cohesion: 0.22
Nodes (6): DailySummaryUpdater, Updates daily stock price data for all companies using ShareSansar's Today Price, Updates daily stock price data for all companies using ShareSansar's Today Price, Fetch today's data and update all company CSVs, Fetch today's data and update all company CSVs, init()

### Community 68 - "Community 68"
Cohesion: 0.28
Nodes (9): fmt(), fmtCompact(), isMarketOpen(), renderShareholdingDonut(), runCagrCalc(), setText(), showCagrResults(), showFundamentals() (+1 more)
...
## Knowledge Gaps
- **411 isolated node(s):** `Classify a NEPSE listing by instrument type.  ShareSansar's registry mixes ordin`, `Return the instrument type for a listing's display name.`, `True for ordinary shares — the only instruments the analyser handles.`, `NEPSE Stock CAGR Calculator ============================ Uses data from: https:/`, `Load right-share.csv for the given symbol.     Columns: ratio, total_units, issu` (+406 more)
...
- **Why does `js()` connect `Community 2` to `Community 0`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 15`, `Community 18`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 31`, `Community 33`, `Community 35`, `Community 41`, `Community 44`, `Community 48`, `Community 49`, `Community 53`, `Community 61`, `Community 62`, `Community 64`, `Community 67`, `Community 74`, `Community 77`, `Community 78`?**
  _High betweenness centrality (0.270) - this node is a cross-community bridge._
- **Why does `bn` connect `Community 24` to `Community 2`, `Community 9`, `Community 44`, `Community 15`, `Community 49`, `Community 18`, `Community 61`, `Community 62`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `load_positions()` connect `Community 28` to `Community 24`?**
