...
## Corpus Check
- 57 files · ~387,043 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1876 nodes · 4573 edges · 87 communities (77 shown, 10 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 131 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1fe4db61`
...
Cohesion: 0.05
Nodes (33): As(), ca(), _calculateBarIndexPixels(), _calculateBarValuePixels(), fn, getBasePixel(), getLabelAndValue(), getMaxOverflow() (+25 more)
...
Cohesion: 0.05
Nodes (47): DailyScraperManager, Run the daily update:           - Refresh company ID mapping (catches new IPOs), Run the daily update:           - Refresh company ID mapping (catches new IPOs), Run the daily update:           - Refresh company ID mapping (catches new IPOs), Manages daily scraping tasks for priority companies (company_list.json):       -, Manages daily scraping tasks for priority companies (company_list.json):       -, Load the priority company list from company_list.json., Load the priority company list from company_list.json. (+39 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (58): _apply_eps_fallback(), _apply_hydro_capacity(), _extract_fy(), _fetch_chukul_paid_up_capital(), _fetch_nepsealpha_paid_up_capital(), _fetch_shareholding(), _fetch_sharesansar_shares(), _firecrawl_markdown() (+50 more)
...
Cohesion: 0.05
Nodes (34): be(), beforeDraw(), dataset(), ei(), getRange(), gi(), hi(), index() (+26 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (10): afterEvent(), an(), destroy(), f(), initialize(), ke(), p(), reset() (+2 more)
...
Cohesion: 0.07
Nodes (18): at(), bn, cn(), constructor(), de, dn(), dt(), e() (+10 more)
...
Cohesion: 0.08
Nodes (28): _(), ao(), b(), ce(), co(), Do(), g(), getCenterPoint() (+20 more)

### Community 12 - "Community 12"
Cohesion: 0.12
Nodes (6): ba(), configure(), getPixelForTick(), ks(), Us(), xa

### Community 13 - "Community 13"
Cohesion: 0.18
Nodes (17): afterDraw(), ai(), draw(), ea(), ft(), gs(), ie, ki() (+9 more)
...
Cohesion: 0.1
Nodes (4): addElements(), tn, Ue(), w()

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (27): _apply_dismissed_to_report(), get_merger_info(), _last_news_scan(), _last_scheduled_news_run(), _load_companies(), _load_dismissed_news_urls(), _load_merger_meta(), Return companies matching q by exact ticker, ticker prefix, or name substring. (+19 more)

### Community 17 - "Community 17"
Cohesion: 0.11
Nodes (14): Bi(), gt(), it(), jt(), kt(), mt(), pt(), qt() (+6 more)
...
Cohesion: 0.11
Nodes (11): ct(), ds(), fs(), ge(), ls, ms(), pe(), rs (+3 more)

### Community 20 - "Community 20"
Cohesion: 0.13
Nodes (8): addBox(), bt, mn(), on(), pn(), qs(), start(), stop()
...
Cohesion: 0.15
Nodes (7): afterUpdate(), beforeUpdate(), c(), d(), di(), update(), Xs()
...
Cohesion: 0.18
Nodes (10): beforeDatasetDraw(), beforeDatasetsDraw(), da(), fa(), ga(), ha, na(), pa() (+2 more)
...
Cohesion: 0.21
Nodes (7): aa(), afterDatasetsUpdate(), bs, la(), oa(), onClick(), ta()
...
Cohesion: 0.25
Nodes (6): es(), generateLabels(), is(), qi, ss(), ts()
...
## Knowledge Gaps
- **479 isolated node(s):** `Classify a NEPSE listing by instrument type.  ShareSansar's registry mixes ordin`, `Return the instrument type for a listing's display name.`, `True for ordinary shares — the only instruments the analyser handles.`, `NEPSE Stock CAGR Calculator ============================ Uses data from: https:/`, `Resolve a user-typed symbol to either a company ticker or a sector index.     Re` (+474 more)
...
- **Why does `js()` connect `Community 6` to `Community 0`, `Community 1`, `Community 67`, `Community 35`, `Community 7`, `Community 39`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 45`, `Community 15`, `Community 17`, `Community 19`, `Community 20`, `Community 22`, `Community 25`, `Community 29`?**
  _High betweenness centrality (0.251) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 62` to `Community 3`, `Community 68`, `Community 44`, `Community 14`, `Community 46`, `Community 16`, `Community 56`, `Community 27`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `bn` connect `Community 9` to `Community 0`, `Community 20`, `Community 6`, `Community 22`?**
