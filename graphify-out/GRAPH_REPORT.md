# Graph Report - Nepse-CAGR  (2026-05-31)

## Corpus Check
- 33 files · ~376,520 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1276 nodes · 3620 edges · 30 communities detected
...
- `Return companies matching q by exact ticker, ticker prefix, or name substring.` --uses--> `ShareHubListingDateScraper`  [INFERRED]
  nepse_cagr_server.py → scraper/core/listing_date.py
- `Return companies matching q by exact ticker, ticker prefix, or name substring.` --uses--> `MerolaganiFundamentalsScraper`  [INFERRED]
  nepse_cagr_server.py → scraper/core/fundamentals.py
...
Cohesion: 0.03
Nodes (52): _(), addBox(), addElements(), As(), b(), beforeUpdate(), bo, bs (+44 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (79): get_first_trading_date(), main(), Return the earliest date in prices.csv for this symbol., BaseHTTPRequestHandler, DailyScraperManager, DailySummaryUpdater, Updates daily stock price data for all companies using ShareSansar's Today Price, Updates daily stock price data for all companies using ShareSansar's Today Price (+71 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (66): ao(), at(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeDraw(), c(), _calculateBarIndexPixels(), d() (+58 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (32): afterDatasetsUpdate(), afterEvent(), an(), ci(), cn(), da(), destroy(), dn() (+24 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (38): Ae(), afterDraw(), afterUpdate(), ai(), ba(), ca(), ce(), co() (+30 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (32): a(), aa(), beforeLayout(), bt, buildLookupTable(), buildTicks(), determineDataLimits(), ei() (+24 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (66): FloorsheetScraper, Read the latest (most recent) date already saved in prices.csv.         Returns, _auto_detect_data_dir(), clean_dataframe(), get_latest_date_in_csv(), _print_row(), prompt_for_date(), query_index() (+58 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (62): backDestination, bearBottoms, buildChart(), buildFdChart(), bullCyclePlugin, bullCycles, bullTops, chartLabels (+54 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (13): bn, cs, fe(), getPixelForTick(), nn(), on(), pi(), pn() (+5 more)
...
Cohesion: 0.11
Nodes (15): Bi(), constructor(), de, dt(), gt(), jt(), kt(), mt() (+7 more)
...
## Knowledge Gaps
- **190 isolated node(s):** `NEPSE Stock CAGR Calculator ============================ Uses data from: https:/`, `Load right-share.csv for the given symbol.     Columns: ratio, total_units, issu`, `Calculate total return and CAGR for a NEPSE stock over a date window.      Corpo`, `Importable function. Returns a dict with full breakdown + cagr_pct.      Example`, `NEPSE Stock CAGR Calculator ============================ Uses data from: https:/` (+185 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 26`** (2 nodes): `run_index_history.py -------------------- CLI entry point for scraping NEPSE ind`, `run_index_history.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `A company name is safe to substring-match only when long enough and         most`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (1 nodes): `Read the ShareSansar company-page info table into {Key: Value}.          Field n`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (1 nodes): `Split a ShareSansar 'companies' cell into individual company names.          Nam`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `js()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 10`, `Community 11`?**
  _High betweenness centrality (0.351) - this node is a cross-community bridge._
- **Why does `init()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 6` to `Community 1`, `Community 7`?**
