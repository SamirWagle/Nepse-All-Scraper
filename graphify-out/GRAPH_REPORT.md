...
## Corpus Check
- 57 files · ~387,287 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1881 nodes · 4580 edges · 100 communities (85 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 131 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3e70b8e1`
...
Cohesion: 0.05
Nodes (35): a(), beforeLayout(), bo, buildTicks(), determineDataLimits(), ei(), En, Fo() (+27 more)
...
Cohesion: 0.05
Nodes (29): DailySummaryUpdater, Updates daily stock price data for all companies using ShareSansar's Today Price, Updates daily stock price data for all companies using ShareSansar's Today Price, Fetch today's data and update all company CSVs, Fetch today's data and update all company CSVs, addBox(), addElements(), bt (+21 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (46): DailyScraperManager, Run the daily update:           - Refresh company ID mapping (catches new IPOs), Run the daily update:           - Refresh company ID mapping (catches new IPOs), Run the daily update:           - Refresh company ID mapping (catches new IPOs), Manages daily scraping tasks for priority companies (company_list.json):       -, Manages daily scraping tasks for priority companies (company_list.json):       -, Load the priority company list from company_list.json., Load the priority company list from company_list.json. (+38 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (26): afterUpdate(), buildLookupTable(), c(), d(), di(), et(), generateLabels(), getMaxOverflow() (+18 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (37): _make_session(), MergerRecord, _name_is_matchable(), _normalize_company_name_key(), _parse_company_info_table(), ShareSansar merger announcement scraper.  This scrapes ShareSansar's merger/acqu, Keep already-saved values intact and only fill gaps from newer data., Pull title from <h1>/<title> and body from the article container only.         F (+29 more)
...
Cohesion: 0.15
Nodes (22): afterDraw(), ai(), draw(), ea(), ft(), gs(), he(), ie (+14 more)

### Community 9 - "Community 9"
Cohesion: 0.09
Nodes (18): at(), Bi(), ee, gt(), ii(), it(), jt(), kt() (+10 more)
...
Cohesion: 0.11
Nodes (6): afterEvent(), an(), cn(), f(), onClick(), ts()

### Community 12 - "Community 12"
Cohesion: 0.09
Nodes (27): ao(), be(), dataset(), e(), getCenterPoint(), getRange(), hi(), ho() (+19 more)

### Community 13 - "Community 13"
Cohesion: 0.14
Nodes (8): Ae(), ci(), fi, ks(), po(), Us(), Xs(), y
...
Cohesion: 0.14
Nodes (8): bn, configure(), constructor(), dn(), dt(), i, on(), un()

### Community 24 - "Community 24"
Cohesion: 0.13
Nodes (3): k(), ns(), updateRangeFromParsed()
...
Cohesion: 0.12
Nodes (16): get_merger_info(), _last_news_scan(), _last_scheduled_news_run(), _load_dismissed_news_urls(), _load_merger_meta(), Walk the merger chain to the terminal surviving entity still trading.      Many, Walk the merger chain to the terminal surviving entity still trading.      Many, Walk the merger chain to the terminal surviving entity still trading.      Many (+8 more)

### Community 31 - "Community 31"
Cohesion: 0.18
Nodes (8): bs, _calculateBarValuePixels(), getLabelAndValue(), hn(), n(), resolveDataElementOptions(), updateElements(), vn()
...
Cohesion: 0.16
Nodes (17): compute_float_pct(), fetch_shareholding_nepse(), _get_client(), load_promoter_conversions(), needs_regulator_approval(), Promoter/public shareholding via NEPSE's own API.  Two DIFFERENT questions live, Assumed tradable percentage once the lock-in has expired.      Assumes no promot, True for sectors where lock-in expiry does NOT free promoter shares.      Banks (+9 more)
...
Cohesion: 0.17
Nodes (10): beforeDatasetDraw(), beforeDatasetsDraw(), beforeDraw(), da(), fa(), ga(), ha, na() (+2 more)

### Community 37 - "Community 37"
Cohesion: 0.2
Nodes (18): doCagr(), doSearch(), findPort(), fmt(), localResolveCandidates(), openBullBearFromQuery(), resolveBullSymbol(), resolveSymbol() (+10 more)
...
Cohesion: 0.26
Nodes (7): aa(), afterDatasetsUpdate(), la(), oa(), ra(), ta(), update()
...
Cohesion: 0.2
Nodes (8): BaseHTTPRequestHandler, calculate_index_cagr(), Handler, Hide a digest item once read, or put it back.          Reversible by design, whi, Hide a digest item once read, or put it back.          Reversible by design, whi, Hide a digest item once read, or put it back.          Reversible by design, whi, Remove one archived digest and its snapshot row. Irreversible., Remove one archived digest and its snapshot row. Irreversible.
...
Cohesion: 0.21
Nodes (9): ca(), _calculateBarIndexPixels(), getBasePixel(), getPixelForTick(), getPixelForValue(), _getRuler(), _getStackCount(), In() (+1 more)

### Community 49 - "Community 49"
Cohesion: 0.16
Nodes (13): doLtpLookup(), fmtCompact(), isMarketOpen(), renderBullBoxes(), renderShareholdingDonut(), setText(), showFundamentals(), esc() (+5 more)

### Community 50 - "Community 50"
Cohesion: 0.22
Nodes (7): fn, go(), parse(), parseArrayData(), parseObjectData(), parsePrimitiveData(), zn()
...
Cohesion: 0.15
Nodes (10): _apply_hydro_capacity(), _fetch_sharesansar_shares(), Return fundamentals dict for symbol. Uses cache when fresh., Return fundamentals dict for symbol. Uses cache when fresh., Fill installed capacity (MW) from the cached Chukul scrape, hydro sector only., Return fundamentals dict for symbol. Uses cache when fresh., Scrape 'Listed Shares' from ShareSansar's company page. Returns float or None., Scrape 'Listed Shares' from ShareSansar's company page. Returns float or None. (+2 more)
...
Cohesion: 0.27
Nodes (12): _(), b(), g(), gi(), m(), mi(), o(), p() (+4 more)

### Community 61 - "Community 61"
Cohesion: 0.23
Nodes (6): beforeUpdate(), es(), initialize(), is(), reset(), ss()
...
Cohesion: 0.22
Nodes (10): _fetch_chukul_paid_up_capital(), _fetch_nepsealpha_paid_up_capital(), _firecrawl_markdown(), Merolagani fundamentals scraper.  Scrapes per-company fundamentals from:     htt, Fetch a JS-rendered page's markdown via Firecrawl. Returns str or None.      Cos, Fetch a JS-rendered page's markdown via Firecrawl. Returns str or None.      Cos, Fetch 'Paid Up Capital' from nepsealpha.com (JS-rendered — needs Firecrawl)., Fetch 'Paid-up Capital' from chukul.com (JS-rendered — needs Firecrawl).     Val (+2 more)
...
Cohesion: 0.22
Nodes (8): _apply_eps_fallback(), _extract_fy(), Return last 3 years of financial_history.csv rows, newest first., Return last 3 years of financial_history.csv rows, newest first., Fill EPS/P-E from the NepseAlpha quarterly file when Merolagani has none.      M, Extract FY tag like '(FY:082-083, Q:3)' from value string., Extract FY tag like '(FY:082-083, Q:3)' from value string., _read_financial_history()
...
Cohesion: 0.29
Nodes (7): _load_companies(), Return companies matching q by exact ticker, ticker prefix, or name substring., Return companies matching q by exact ticker, ticker prefix, or name substring., Return companies matching q by exact ticker, ticker prefix, or name substring., Return companies matching q by exact ticker, ticker prefix, or name substring., Return companies matching q by exact ticker, ticker prefix, or name substring., search_companies()
...
Cohesion: 0.33
Nodes (6): _parse_number(), _parse_range(), Parse leading numeric token from raw text → float.      Handles: '143,402,084,10, Parse leading numeric token from raw text → float.      Handles: '143,402,084,10, Parse '562.00-471.00' → (562.00, 471.00). Returns (None, None) on failure., Parse '562.00-471.00' → (562.00, 471.00). Returns (None, None) on failure.

### Community 80 - "Community 80"
Cohesion: 0.33
Nodes (6): _parse_nepali_fy(), Append current EPS to eps_history.csv when this fiscal year is new.      File co, Append current EPS to eps_history.csv when this fiscal year is new.      File co, Normalise Nepali fiscal year string to sortable form '082-083'.      Accepts: '0, Normalise Nepali fiscal year string to sortable form '082-083'.      Accepts: '0, _update_eps_history()

### Community 81 - "Community 81"
Cohesion: 0.33
Nodes (6): _fetch_shareholding(), Accumulate yearly financial snapshots to financial_history.csv.      Columns: fi, Accumulate yearly financial snapshots to financial_history.csv.      Columns: fi, Scrape promoter/public share counts and financial metrics from ShareHubNepal., Scrape all-time-high and misc financial metrics from ShareHubNepal.      Promote, _update_financial_history()
...
Cohesion: 0.5
Nodes (4): _apply_dismissed_to_report(), Hide dismissed rows at serve time instead of mutating the cached     report file, Hide dismissed rows at serve time instead of mutating the cached     report file, Hide dismissed rows at serve time instead of mutating the cached     report file
...
## Knowledge Gaps
- **483 isolated node(s):** `Classify a NEPSE listing by instrument type.  ShareSansar's registry mixes ordin`, `Return the instrument type for a listing's display name.`, `True for ordinary shares — the only instruments the analyser handles.`, `NEPSE Stock CAGR Calculator ============================ Uses data from: https:/`, `Resolve a user-typed symbol to either a company ticker or a sector index.     Re` (+478 more)
...
- **Why does `js()` connect `Community 4` to `Community 0`, `Community 2`, `Community 8`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 31`, `Community 36`, `Community 40`, `Community 41`, `Community 43`, `Community 48`, `Community 50`, `Community 59`, `Community 60`, `Community 61`, `Community 65`, `Community 67`, `Community 74`, `Community 75`, `Community 82`?**
  _High betweenness centrality (0.249) - this node is a cross-community bridge._
- **Why does `bn` connect `Community 23` to `Community 2`, `Community 4`, `Community 40`, `Community 41`, `Community 24`, `Community 25`, `Community 31`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 39` to `Community 3`, `Community 37`, `Community 10`, `Community 47`, `Community 17`, `Community 58`, `Community 30`?**
